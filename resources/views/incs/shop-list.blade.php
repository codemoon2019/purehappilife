                        ...
                        @foreach($data as $data)        
                            <div class="col-lg-4 col-sm-6 col-md-4 mb-5 grid-list">
                                <div class="single-product position-relative">
                                    <span class="badge badge-primary cb3">Art</span>
                                    <div class="product-thumbnail position-relative text-center">
                                            ...
                                            @else
                                                <a href="{{ Auth::check() ? '/home/product-info/'.$data->id : '/product-info/'.$data->id }}">
                                                    <img class="first-img" src="{{ $data->product_image_url }}" style="height:350px; width:350px;" alt="thumbnail">
                                                </a>
                                            @endif
                                    ...
                                    <div class="product-desc pt-2rem position-relative text-center">
                                        ...
                                        <button class="pro-btn {{ Auth::check() ? 'btn-add' : 'btn-add-to-cart-disabled' }}" data-id="{{ $data->id }}" action-type="cart" style="width:100%;">add to cart  <i class="ion-bag"></i></button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
