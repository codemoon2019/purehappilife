        ...
        <table class="table m-0">
            <tbody>
                <tr>
                    ...
                    <td class="text-right"><span class="cart-total-price">₱ {{ number_format($guestCart->sum('total_price')) }}</span></td>
                </tr>
            </tbody>
        </table>
        <div class="cart-buttons pt-5">
            <a href="/checkout" class="btn btn-primary btn-block rounded">Checkout</a>
        </div>
    </div>
@endif
